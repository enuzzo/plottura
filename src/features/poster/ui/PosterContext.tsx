...
export const DEFAULT_FORM: PosterForm = {
  ...
  placeLabelDensity: "6",
  includeWaterLabels: false,
  includeMountainPeaks: false,
  showMarkers: true,
  ...
  const mapStyle = useMemo(
    () =>
      generateMapStyle(effectiveTheme, {
        ...
        includeBoundary: state.form.includeBoundary,
        includeLandcover: state.form.includeLandcover,
        includePlaceLabels: state.form.includePlaceLabels,
        placeLabelDensity: Number(state.form.placeLabelDensity) || 6,
    ...
    [
      ...
      state.form.includeBoundary,
      state.form.includeLandcover,
      state.form.includePlaceLabels,
      state.form.placeLabelDensity,
      state.form.includeWaterLabels,
      state.form.includeMountainPeaks,
      state.form.distance,
      state.form.enable3D,
